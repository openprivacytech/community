...
If you are a Technical Writer and interested to contribute to OpenPrivacyTech in the Google Season of Docs 2023, you can start working on your proposal and send your proposal by following the [template of writing the statement of interest](https://developers.google.com/season-of-docs/docs/tech-writer-statement) to [info@openprivacytech.org](mailto:info@openprivacytech.org), please note that we'll reach out the candidates once the season of docs organizations are announced.
