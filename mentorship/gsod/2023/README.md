...
If you are a Technical Writer and interested to contribute to OpenPrivacyTech in the Google Season of Docs 2023, you can start working on your proposal and send your draft proposal by following the [template of writing the statement of interest](https://developers.google.com/season-of-docs/docs/tech-writer-statement) to [info@openprivacytech.org](mailto:info@openprivacytech.org), Kindly note that we will be contacting all candidates who had shared their interest working with OpenPrivacyTech via email once the participating organizations announced for this year's Season of Docs.
